...
class Configs(object):
    def __init__(self):
        ...
        parser.add_argument('--log_period', type=int, default=20000, help='log_period')
        parser.add_argument('--eval_period', type=int, default=50, help='eval_period')
        ...
        parser.add_argument('--fine_grained', type='bool', default=False, help='load_model')


        # @ ----------training ------
        parser.add_argument('--max_epoch', type=int, default=200, help='max epoch number')
        parser.add_argument('--num_steps', type=int, default=100000, help='max steps num')
        ...
        # ------- name --------
        self.train_data_name = 'train_5500.label.txt'
        self.dev_data_name = 'TREC_10.label.txt'
        ...
        if not self.network_type == 'test':
            params_name_list = ['network_type', 'fine_grained', 'dropout', 'wd', 'optimizer', 'learning_rate']
        ...
        # ---------- dir -------------
        self.data_dir = join(self.dataset_dir, 'QuestionClassification')
